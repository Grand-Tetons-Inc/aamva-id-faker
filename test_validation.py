#!/usr/bin/env python3
"""Quick validation engine test script."""
...
# We need to handle the import issue with parent package
# Let's just test the validators directly without going through __init__
import os
os.chdir('/home/user/aamva-id-faker')

# Import validation components
from aamva_license_generator.validation.validators import (
    LicenseValidator,
    StateCodeValidator,
    DateValidator,
    LicenseNumberValidator,
)
from aamva_license_generator.validation.schemas import ValidationLevel
from aamva_license_generator.validation.aamva_compliance import check_aamva_compliance
...
print('='*60)
lic_validator = LicenseNumberValidator()
...
aamva_result = check_aamva_compliance(aamva_data)
...
print('  ✓ State-specific license format validation')
print('  ✓ AAMVA compliance checking')
print('  ✓ Comprehensive error messages')
print('  ✓ Validation levels (ERROR, WARNING, INFO)')
